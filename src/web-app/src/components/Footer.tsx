      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2">
                ...
                <span className="text-violet-200">hello@seika.edu</span>
              </li>
              <li className="flex items-start gap-2">
              ...
              <li className="flex items-start gap-2">
                ...
                <span className="text-violet-200">123 Education St, Learning City, LC 12345</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-violet-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-violet-300 text-sm">© 2026 Seika. All rights reserved.</p>
            <div className="flex gap-6 text-sm">
              <a href="#" className="text-violet-300 hover:text-amber-400 transition-colors">
                Privacy Policy
              </a>
              <a href="#" className="text-violet-300 hover:text-amber-400 transition-colors">
                Terms of Service
