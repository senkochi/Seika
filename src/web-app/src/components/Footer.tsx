...
export function Footer() {
  return (
    <footer id="contact" className="bg-gradient-to-br from-purple-900 via-purple-800 to-purple-900 text-white py-16">
        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          <div className="md:col-span-2">
            ...
            <p className="text-purple-200 mb-6">
              Transform education into an adventure! Join thousands of students, teachers, and schools already using Seika to make learning fun.
            </p>
          ...
          <div>
            <h4 className="font-black mb-4">Contact Us</h4>
            <ul className="space-y-3">
              <li className="flex items-start gap-2">
                <Mail className="w-5 h-5 text-yellow-400 flex-shrink-0 mt-0.5" />
                <span className="text-purple-200">hello@seika.edu</span>
              </li>
              <li className="flex items-start gap-2">
              ...
              <li className="flex items-start gap-2">
                ...
                <span className="text-purple-200">123 Education St, Learning City, LC 12345</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-purple-700 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-purple-300 text-sm">
              © 2026 Seika. All rights reserved.
            </p>
