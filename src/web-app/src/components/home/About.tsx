    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 lg:py-12">
          ...
          <div className="grid gap-16 md:grid-cols-2">
            {teamMembers.map((member) => (
              <div key={member.name} className="flex flex-col items-center text-center">
                ...
                <p className="mt-6 text-xs uppercase tracking-[0.3em] text-violet-200/70">
                  {member.role}
                </p>
                <h3 className="mt-2 text-2xl font-black text-amber-300">{member.name}</h3>
                <p className="mt-3 text-sm text-violet-100/80 max-w-sm leading-relaxed">
                  {member.bio}
                </p>
        ...
        <div className="mt-40 max-w-4xl mx-auto text-center relative z-10">
          ...
          <h3 className="text-4xl md:text-6xl font-black text-amber-400 mb-6">
            Our Mission
          </h3>
