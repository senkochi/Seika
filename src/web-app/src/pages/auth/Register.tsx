...
export default function Register() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-950 via-purple-900 via-30% to-amber-600 via-60% to-violet-950 relative overflow-hidden flex items-center justify-center p-4">
      ...
      <div className="absolute bottom-20 right-10 w-40 h-40 bg-violet-500 rounded-full opacity-10 blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
      ...
      <div className="absolute bottom-10 left-1/4 w-48 h-48 bg-violet-500 rounded-full opacity-10 blur-3xl animate-pulse" style={{ animationDelay: '0.5s' }}></div>
      {/* Back to Home Button */}
      <button
        type="button"
        onClick={() => navigate('/')}
