...
$body1 = @{
    ...
    routing_key = "wallet.debit.succeeded"
    payload = $order1Payload
    payload_encoding = "string"
} | ConvertTo-Json

$res1 = Invoke-RestMethod -Uri 'http://localhost:15672/api/exchanges/%2F/wallet.events/publish' -Method Post -Headers $header -ContentType 'application/json' -Body $body1
...
$res2 = Invoke-RestMethod -Uri 'http://localhost:15672/api/exchanges/%2F/wallet.events/publish' -Method Post -Headers $header -ContentType 'application/json' -Body $body2
