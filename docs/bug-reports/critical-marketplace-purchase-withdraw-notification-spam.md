...
1. **Mua hàng bị đặt tên nhầm là rút tiền. (Lý do Notification sai thông tin)**  
...
2. **Code và database không cùng schema. (Lý do bị spam)**  
...
3. **Notification được gửi trước khi transaction database commit. (Lý do bị spam)**  
...
> Thông báo được gửi trước, nhưng vì database sai schema nên không thể lưu được. Mỗi khi không lưu được thì sẽ có một request yêu cầu lại nghiệp vụ này -> Thông báo lại được gửi và database thì không lưu,... vòng lặp cứ như vậy rồi tạo ra spam và crash
